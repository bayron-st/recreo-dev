		...
		<div class="main-content-wrapper">
            ...
            action="<?php echo site_url('login/reset_password');?>">
                ...
                required autocomplete="off">
						...
						<button type="submit" class="btn btn-primary"><?php echo 'Recuperar Contraseña' ?><i class="fa fa-unlock"></i></button>
					</form>

					<div class="login-bottom-links">
						<a href="<?php echo site_url('login');?>" class="link"><i class="fa fa-lock"></i><?php echo 'Regresar a iniciar sesión' ?></a>
					</div>
				</div>
			</div>
