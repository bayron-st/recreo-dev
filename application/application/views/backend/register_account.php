		...
		<div class="main-content-wrapper">
          ...
          <?php echo form_open(site_url('login/register/create') , array('enctype' => 'multipart/form-data'));?>
						...
						<div class="form-group">
							<input type="text" class="form-control" name="name" required placeholder="<?php echo 'NOMBRES'?> "
                required autocomplete="off">
						</div>

            <div class="form-group">
							<input type="text" class="form-control" name="apellido" required placeholder="<?php echo 'APELLIDOS'?>"
                required autocomplete="off">
						</div>
            ...
            <div class="form-group">
                ...
                <select name="identificacion" required class="form-control selectboxit">
            ...
            <div class="form-group">
							<input type="text" class="form-control" name="num_documento"  required placeholder="<?php echo 'NUMERO DE DOCUMENTO'?>"
                required autocomplete="off">
						</div>

            <div class="form-group">

                <select name="pais" class="form-control selectboxit" required>>
            ...
            <div class="form-group">
                ...
                <input type="text" name="fecha_nacimiento" id="datepicker" class="form-control" required placeholder="<?php echo 'FECHA DE NACIMIENTO'?>" autocomplete="off" >
            ...
            <div class="form-group">
							<input type="text" class="form-control" name="phone" required placeholder="<?php echo 'CELULAR'?>"
                required autocomplete="off">
						</div>

            <div class="form-group">
							<input type="email" class="form-control" name="email" required placeholder="<?php echo 'CORREO ELECTRONICO'?>"
                required autocomplete="off">
						</div>

            <div class="form-group">
							<input type="password" class="form-control" name="password" required placeholder="<?php echo 'CONTRASEÑA'?> >"
                required autocomplete="off">
						</div>
                  ...
                  <label for=""><a href="https://elrecreoesdetodos.com/TYC/terminosYCondiciones.pdf" target="_blank" style="color:white"> Ver terminos y condiciones </a></label>
                         <label>
                         			<input type="radio"  name="aceptar" value="aceptar"   checked="" required> Aceptar términos y condiciones
                        </label>
         		</div>
