...
<div id="modalConsole" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h3 class="text-danger text-center" style="margin-bottom: 35px; color: #0050B0;"><i class="fa fa-warning"></i> NOTICIA IMPORTANTE</h3>
                <p class="text-justify" style="font-size:16px; color:#333">APROVECHA YA Y REDIME TUS PREMIOS DE FORMA INMEDIATA CON LOS CRÉDITOS ACUMULADOS QUE TIENES. RECUERDA QUE ESTO NO TE RESTA CRÉDITOS DE TU ACUMULADO EN EL RANKING PARA PARTICIPAR POR LAS CONSOLAS DE VIDEO JUEGOS PS4</p>
            </div>
        </div>
    </div>
</div>