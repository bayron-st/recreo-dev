...
foreach ($data as $row) {
	$nCreditos = $row['CANTIDAD'];
}
foreach ($data2 as $row2) {
	$nCreditos2 = $row2['CANTIDAD2'];
}
foreach ($data3 as $row3) {
	$nCreditos3 = $row3['CANTIDAD3'];
}
foreach ($data4 as $row4) {
	$nCreditos4 = $row4['CANTIDAD4'];
}
...
?>
<div class="row">
	<div class="col-md-6" style="background-color:#0050B0;">
		<div class="panel" style="margin-top:20px;">
			<div class="panel-heading">
				<div class="panel-title">
					<h2 class="text-info text-center">Datos de usuario</h2>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-6 col-xs-12">
				<div class="tile-stats tile-blue">
					...
					<div class="num"><?php if ($nCreditos > 0) {
											echo $nCreditos;
										} else echo '0'; ?></div>
			...
			<div class="col-md-6 col-xs-12">
				<div class="tile-stats tile-gray" style="padding:10px;">
					<div class="icon"> <img src="<?php echo site_url('../uploads/imagen_creditos_color.png'); ?>"></div>
					<p style="font-size:20px"><?php if ($nCreditos2 > 0) {
													echo $nCreditos2;
												} else echo '0'; ?></p>
				...
				<div class="tile-stats tile-gray" style="padding:10px;">
					<div class="icon"> <img src="<?php echo site_url('../uploads/imagen_creditos_color.png'); ?>"></div>
					<p style="font-size:20px"><?php if ($nCreditos3 > 0) {
													echo $nCreditos3;
												} else echo '0'; ?></p>
