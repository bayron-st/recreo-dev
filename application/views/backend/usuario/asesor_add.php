		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo 'Formulario de Registro';?>
            	</div>
            </div>
			<div class="panel-body">

            <?php echo form_open(site_url('admin/asesor/create') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="name" data-validate="required" data-message-required="<?php echo 'LLenar campo de registro';?>" value="" autofocus>
						</div>
					</div>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo 'Ingresar Asesor';?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
