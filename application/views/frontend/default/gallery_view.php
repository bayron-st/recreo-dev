                    ...
                    <div class="album-content lightbox-popup">
                        <div class="card-columns">
                            <?php foreach ($images as $image) { ?>
                              <div class="card">
                                  <a href="<?php echo base_url(); ?>uploads/frontend/gallery_images/<?php echo $image['image'];?>">
                                      <img class="img-fluid" alt=""
                                        src="<?php echo base_url(); ?>uploads/frontend/gallery_images/<?php echo $image['image'];?>">
                                  </a>
                              </div>
                            <?php } ?>
                        </div>
