...
$database_elrecreoweb = "elrecqcg_dashboard";
...
$connElrecqcgWeb = mysqli_connect($hostname_elrecreoweb, $username_elrecreoweb, $password_elrecreoweb, $database_elrecreoweb);
