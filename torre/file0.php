	...
	if ($_FILES['archivo']["error"] > 0)
	...
	else
	  {
		  ...
		  if ($_FILES[uploadedfile][size] < 500000)
		  {
			  ...
			  {
				  move_uploaded_file($_FILES['archivo']['tmp_name'],"../imagenes/fotografias/" . $_FILES['archivo']['name']);
	 ...
	 echo"<script language='javascript'>window.location='agregarEvento.php?idPlan=".$id."'</script>;";
?>