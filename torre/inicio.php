  ...
  <div class="header">
	  ...
	  <!-- InstanceBeginEditable name="EditRegion4" -->
            ...
            <div class="opcionMenu" >
            	<a href="inicio.php"><img src="../imagenes/boton_inicio_roll_over.png" width="100%"  /></a>
            </div> 
            <div class="opcionMenu" >
  ...
  <div class="contentido">
  	<!-- InstanceBeginEditable name="EditRegion3" -->
          ...
          <div class="contentidoIzquierda" align="center">            	
            ...
            <br>
            <div class="recuadroGrisDos" style="background-color:#ffffff; padding:15px;">
                  <!-- <label stile="background-color:#ffffff; padding: 15px">
                    <p style="font-family: Oswald; font-size:16; font-weight: 500; color:#014089;">Felicitaciones, ya eres parte de nuestra<br>MEGAPROMO EL RECREO ES DE TODOS.<br>
                Compra productos en envase Tetra Pak&reg;, acumula<br>créditos, participa y redime fabulosos premios.</p>
                  </label> -->

          		<img src="../imagenes/texto-inicio.jpeg" width="50%" />
            </div>
          </div>  
          <div class="contentidoDerecha">   
              ...
              <br />
              <center><a class="btn btn-small btn-success" style="color:#ffffff" href="https://api.whatsapp.com/send?phone=+51902030519&text=Hola%20quiero%20informaci%C3%B3n" target="_blank"><img src="../imagenes/registra-compras.png" width="90%"></a></center>
              <br>
              <div class="recuadroBlanco">
              ...
              <br />      	         	                 		
              <div class="recuadroBlanco">
              		<img src="../imagenes/texto3.png" width="60%"  />
              </div>      
              <br>        		    	          	
          </div>     
	<!-- InstanceEndEditable -->        
